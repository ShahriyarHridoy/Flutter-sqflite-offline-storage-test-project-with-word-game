...
class EditGameLevel extends StatefulWidget {
  final GameLevel gameLevel;
  const EditGameLevel({Key? key,required this.gameLevel}) : super(key: key);

  @override
  State<EditGameLevel> createState() => _EditGameLevelState();
}

class _EditGameLevelState extends State<EditGameLevel> {
  ...
  void initState() {
    setState(() {
      _gameLevelLettersController.text=widget.gameLevel.letters??'';
      _gameLevelWordsController.text=widget.gameLevel.words??'';
      _gameLevelArrayController.text=widget.gameLevel.array??'';
    });
    super.initState();
  }
  @override
                  ...
                  TextButton(
                      ...
                      onPressed: () async {
                        ...
                        if (_validateLetters == false &&
                          ...
                          _gameLevel.level=widget.gameLevel.level;
                          ...
                          var result=await _gameLevelService.UpdateGameLevel(_gameLevel);
